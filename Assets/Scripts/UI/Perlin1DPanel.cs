...
public class Perlin1DPanel : MonoBehaviour
{
    public Slider nOctavesSlider, bias;
    ...
    public void OnConfirm()
    {
        ...
        if(animate.isOn) {
            ...
            lastCoroutine = StartCoroutine(MapCreationScript.Instance.PerlinNoise1DTerrainAnimation(nOctaves, seed, fBias));
            shouldUpdate = false;
		} else {
            MapCreationScript.Instance.PerlinNoise1DTerrainGeneration(nOctaves, seed, fBias);
            shouldUpdate = true;
		}
	}
